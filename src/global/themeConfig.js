...
const themes = {
    egypt: {
        ...
        //logo: require('./../assets/image/egypt/logo.png'),
    },
    mythology: {
        ...
        //logo: require('./../assets/image/other_theme/logo.png'),
    },
    pilot: {
        gameCenterIcon: require('./../assets/image/pilot/game_center_icon.png'),
        backgroundLoop: require('./../assets/video/pilot/background_movie_loop.mp4'),
        //logo: require('./../assets/image/other_theme/logo.png'),
    },
    cowboy: {
